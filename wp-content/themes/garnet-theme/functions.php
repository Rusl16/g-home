...
register_sidebar(array( // регистрируем левую колонку, этот кусок можно повторять для добавления новых областей для виджитов
	...
	'before_widget' => '<div id="%1$s" class="widget clearfix %2$s">', // разметка до вывода каждого виджета
...
function add_styles() { // добавление стилей
    ...
    wp_enqueue_style( 'pr', get_template_directory_uri().'/single-portfolio.css' ); // бутстрап
